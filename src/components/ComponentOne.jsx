	...
	return (
		<div className='first-container'>
			<div className='first-container-left'>
				<div className='first-container-left-head'>
					<svg
						width='24'
						height='24'
						viewBox='0 0 24 24'
						fill='none'
						class='HeroPill__NakedBitcoinIcon-sc-16ndsef-2 gLnfIS'
					>
						<path
					...
					<p style={{ color: '#1652f0', marginLeft: '5px', marginRight: '5px' }}>Jump start your portofolio</p>
					<svg
						width='16'
						height='12'
						viewBox='0 0 16 12'
				...
				<div className='first-container-left-title'>
					<span>
						Jump start <br /> your crypto
						<br /> portfolio
					</span>
				</div>
				<div className='first-container-left-content'>
					<span>
						Coinbase is the easiest place to buy and sell <br /> cryptocurrency. Sign up and get started today.
					</span>
				</div>
				<div className='first-container-left-foot-detail'>
					<input type='text' placeholder="Email address"/>
					<Button label='Get started' styles={{ backgroundColor: 'blue', color: '#fff', fontWeight: '700', height: '50px', width: '120px', marginLeft: '10px'}} />
				</div>
				<div className='first-container-left-link'>
                    <span >*Terms apply</span>
                </div>
			</div>
			<div className='first-container-right'>
				<div className='first-container-right-image'>
					<svg
						width='680'
						height='956'
						viewBox='0 0 680 956'
